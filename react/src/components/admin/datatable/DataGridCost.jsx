...
export default function DataGridCost(props) {
  ...
  const [filters, setFilters] = useState({
    ...
    "province.name": { value: null, matchMode: FilterMatchMode.CONTAINS },
    "district.name": { value: null, matchMode: FilterMatchMode.CONTAINS },

    "ward.name": { value: null, matchMode: FilterMatchMode.CONTAINS },
  });

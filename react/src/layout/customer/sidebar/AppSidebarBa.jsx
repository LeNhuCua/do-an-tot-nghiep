...
export default function AppSidebarBa() {
        ...
        <div className="">
          <div className="bg-gray-600 py-2 flex justify-center">
            <div className="border rounded-full bg-gray-200 px-2 max-w-[240px]  items-center flex">
              <input
                className="w-full focus:ring-0 bg-transparent outline-none border-none placeholder:text-black placeholder:text-xs  py-2"
                type="text"

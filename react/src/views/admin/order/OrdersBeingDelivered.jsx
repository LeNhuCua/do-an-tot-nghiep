...
const OrdersBeingDelivered = () => {
  ...
  const fetchOrdersNew = async () => {
    await axiosClient.get(`${API}/api/orders/ordersBeingDelivered`).then(({ data }) => {
...
export default OrdersBeingDelivered;

...
const SearchProducts = () => {
  ...
  const fetchProductCategories = async (pageNumber = 1) => {
    ...
    //   `${API}/api/cus-products/showCategories?search=${search}&&page=${page}&&sortRating=${sortRating}&&sortPrice=${sortPrice}`
    // );
    const response = await axios.get(
      `${API}/api/cus-products/searchProducts?search=${search}&&page=${page}&&sort=${sort.code}&&fillPrice=${fillPrice.code}`
    );
